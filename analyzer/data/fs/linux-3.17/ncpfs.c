...
static inline u16 WVAL_LH_ncplib_kernel_c(const void *data)
{
...
static inline u32 DVAL_LH_ncplib_kernel_c(const void *data)
{
...
{
	target->mode = DVAL_LH_ncplib_kernel_c(structure);
	target->rdev = DVAL_LH_ncplib_kernel_c(structure + 8);
}
#endif
			   ...
			   size_t* rsize)
{
	...
	*rbuf = buffer + 12;
	*cnt = WVAL_LH_ncplib_kernel_c(buffer + 10);
	*more = BVAL(buffer + 9);
	memcpy(seq, buffer, 9);
	return 0;
}
...
#endif
/************************************************************/
/* ../linux-3.17/fs/ncpfs/ncplib_kernel.c */
/************************************************************/
/*
...
#endif	/* CONFIG_NCPFS_PACKET_SIGNING */
/************************************************************/
/* ../linux-3.17/fs/ncpfs/ncpsign_kernel.c */
/************************************************************/
/*
 * getopt.c
 */
