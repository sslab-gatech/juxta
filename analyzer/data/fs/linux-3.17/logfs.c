...
static void logfs_mark_segment_bad_gc_c(struct super_block *sb, u32 segno)
{
	BUG();
}
...
static u32 logfs_gc_segment(struct super_block *sb, u32 segno)
{
	...
	if (sh.crc != logfs_crc32(&sh, sizeof(sh), 4)) {
		logfs_mark_segment_bad_gc_c(sb, segno);
		cleaned = -1;
		goto out;
	}
...
/************************************************************/
/* ../linux-3.17/fs/logfs/readwrite.c */
/************************************************************/
/*
...
/************************************************************/
/* ../linux-3.17/fs/logfs/dev_bdev.c */
/************************************************************/
/*
